### Development
[Full Changelog](http://github.com/rspec/rspec-mocks/compare/v3.5.0...master)

Bug Fixes:

* Return the instance of the test double from
  `double.freeze` (Alessandro Berardi, #1109)
