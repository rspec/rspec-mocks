  ...
  module Mocks
    ...
    class MessageExpectation
      ...
      module ImplementationDetails
        ...
        attr_writer :expected_from, :argument_list_matcher
        protected :expected_from=, :error_generator, :error_generator=, :implementation=
      ...
      private
        ...
        def invoke_incrementing_actual_calls_by(increment, allowed_to_fail, parent_stub, *args, &block)
          ...
          increase_actual_received_count!(increment)
        end
